...
cv2.putText(image_rgb, 'center1', (center1_x - 40, center1_y + 40), font, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'center2', (center2_x - 40, center2_y + 40), font, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
...
height_label_pos = (arrow_start[0] - 150, (arrow_end[1] - arrow_start[1]) // 2)
cv2.putText(image_rgb, f"Height: {height}px", height_label_pos, font, 0.8, (255, 255, 0), 2, cv2.LINE_AA)

plt.figure(figsize = (12,8))
plt.imshow(image_rgb)
plt.title("Image Annotation with shapes and measurements")
plt.axis('off')
plt.show()